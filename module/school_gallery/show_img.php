...
<?php
		...
		$school_gallery=fetchAll("select id,category_id,photo,status from school_gallery where category_id=$_POST[id] and status='y'");
?>
		...
		<div class="container1">
			<div class="agileits-special-grids">
				<div id="owl-demo" class="owl-carousel owl-theme">
					...
					?>
								<a href="#" ><img src=<?php echo SITE_IMAGES."school_gallery/$school_gallery[photo]";?> alt="" width="260px" height="190px" style="padding-top:8px;" class="img-responsive"></a>
